...
if [ ! "$CURRENT_TAG" = "$POLICY_VERSION" ]; then
    ...
    echo "Policy '$POLICY_VERSION' is going to be published to ghcr.io/jvanz/updatecli/policies/antora"
    pushd policy
    updatecli manifest push --experimental -t "ghcr.io/jvanz/updatecli/policies/antora" --config "updatecli.d" --values "values.d/kubewarden.yaml" .
    popd
fi
